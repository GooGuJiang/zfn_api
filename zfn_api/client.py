...
from .modules.academia import AcademiaMixin
from .modules.auth import AuthMixin
from .modules.courses import CourseMixin
from .modules.grades import GradeMixin
from .modules.info import InfoMixin
from .modules.notifications import NotificationMixin
from .modules.schedule import ScheduleMixin
